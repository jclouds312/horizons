      ...
      <div className="min-h-screen bg-white py-8">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="space-y-8">
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">Términos y Condiciones</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">Devoluciones y Disputas</h2>
              <div className="prose text-gray-600">
                <p className="mb-4">
